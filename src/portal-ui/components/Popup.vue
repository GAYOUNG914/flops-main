<template>
  <transition name="popup-fade">
    <div v-if="visible" class="popup-deem" @click.self="handleClose" :class="{ 'popup-default': isDefault }">
      <div
      ...
      >
        <div class="popup-container-inner">
          ...
          <div class="popup-content">
            ...
            <div class="popup-default-content" v-if="isDefault">
              <div class="default-header">
                <div class="title" v-if="$slots.title">
                  <span class="b1_ko_s"><slot name="title" /></span>
                </div>
                <div class="sub-title" v-if="$slots.subTitle">
                  <span class="b3_ko_s"><slot name="subTitle" /></span>
                </div>
              </div>
              <div class="default-content" v-if="$slots.desc">
                <div class="desc">
                  <span class="b3_ko_s"><slot name="desc" /></span>
                </div>
              </div>
              <div class="default-bottom" v-if="$slots.bottom">
                <slot name="bottom" />
              </div>
            </div>    
