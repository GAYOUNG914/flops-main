          ...
          <ul class="input-table">
            ...
            <li>
              ...
              <div class="content radio-group">
                <Radio class="radio-item" label="일반" v-model="radio" name="important" value="false" />
                <Radio class="radio-item" label="중요" v-model="radio" name="important" value="true" />
              </div>
            </li>
            <li>
              <div class="title">
              ...
              <div class="content radio-group">
                <Radio class="radio-item" label="발송 안 함" v-model="radio2" name="sending" value="false" />
                <Radio class="radio-item" label="발송" v-model="radio2" name="sending" value="true" />
              </div>
            </li>
            <li>
              <div class="title">
